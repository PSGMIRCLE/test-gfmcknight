...
default: test_bst main test_kdt main2 test_kdt2
...
test_kdt2: test_KDT_2.o
	g++ -o test_kdt2 test_KDT_2.o
...
test_KDT_2.o: KDT.hpp BST.hpp BSTNode.hpp BSTIterator.hpp 


clean:
	$(RM) main test_bst test_kdt main2 test_kdt2 *.o
